...
use crate::scene::{
    Light, LightType, Material, MaterialId, MaterialProperties, Mesh, MeshId,
    MeshIndex, PrimitiveType, SceneProperties, Texture, TextureId, Vertex, MAX_LIGHTS,
};
